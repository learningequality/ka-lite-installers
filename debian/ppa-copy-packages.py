#!/usr/bin/python
"""
Copy published precise PPA packages to trusty and upwards

(see list below)

Typical usage:

    - build a ka-lite package for trusty
    - dput ppa:build/ka-lite-source_0.9.0~b2-0ubuntu1_source.changes
